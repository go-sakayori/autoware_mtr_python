...
MAP_TYPE_COLORS: dict[MapType, list[float]] = {
    MapType.ROADWAY: [0.1, 0.9, 0.0, 0.99],  # Green (rgba)
    MapType.BIKE_LANE: [0.0, 0.3, 0.0, 0.99],  # Dark Green (rgba)
    MapType.DASHED: [0.9, 0.9, 0.0, 0.99],  # Yellow (rgba)
    MapType.SOLID: [0.0, 0.9, 0.9, 0.99],  # Cyan (rgba)
    MapType.SOLID_DASH: [0.6, 0.6, 0.1, 0.99],  # Olive (rgba)
    MapType.DOUBLE_DASH: [0.0, 0.0, 0.3, 0.99],  # Dark Blue (rgba)
    MapType.UNKNOWN: [0.99, 0.0, 0.0, 0.99],  # Red (rgba)
    MapType.CROSSWALK: [0.0, 0.0, 0.99, 0.99],  # Blue (rgba)
    MapType.BUS_LANE: [0.4, 0.4, 0.4, 0.99],  # Gray (rgba)
}
